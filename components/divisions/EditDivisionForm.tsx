      ...
      <form onSubmit={handleSubmit} className=" mx-auto space-y-6 ">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className="flex-1 px-4 py-2 bg-gray-100 text-gray-700 rounded text-sm hover:bg-gray-200 transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 px-4 py-2 bg-blue-500 text-white rounded text-sm hover:bg-blue-600 transition-colors disabled:opacity-50 flex items-center justify-center"
          >
            {isSubmitting ? (
              <>
