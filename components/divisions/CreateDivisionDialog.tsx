      ...
      <div className="bg-white rounded-lg shadow-lg max-w-lg w-full max-h-[85vh] overflow-hidden">
        ...
        <div className="bg-gray-50 px-4 py-3 flex flex-col sm:flex-row gap-2">
          <button
            ...
            className="flex-1 px-3 py-2 bg-gray-300 text-gray-700 rounded text-sm hover:bg-gray-200 transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 px-3 py-2 bg-red-900 text-white rounded text-sm hover:bg-red-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
